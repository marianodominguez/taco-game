...
taco: clean
	$(CL) -t $(SYS) -C cfg/tacobot.cfg --mapfile bin/taco.map -O -Os -Oi -Or -Wl "-D__RESERVED_MEMORY__=3600" -I include -o bin/taco src/font.c src/atari_lib.s src/splash.c src/taco.c
clean:
